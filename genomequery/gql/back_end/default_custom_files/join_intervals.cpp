...
void Joined::eval_expressions(int i, int& expr1, int& expr2){
	...
	expr1=((*arg1)[i]<(*arg5)[i]);
	expr2=((*arg2)[i]=="chr1") && ((*arg3)[i]>=0.99) && ((*arg4)[i]=='F');
}
